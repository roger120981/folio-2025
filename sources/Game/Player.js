...
export class Player
{
    ...
    setInputs()
    {
        this.game.inputs.addMap([
            ...
            { name: 'right',                 categories: [ 'playing', 'focus' ], keys: [ 'ArrowRight', 'KeyD' ] },
            { name: 'backward',              categories: [ 'playing', 'focus' ], keys: [ 'ArrowDown', 'KeyS' ] },
            { name: 'left',                  categories: [ 'playing', 'focus' ], keys: [ 'ArrowLeft', 'KeyA' ] },
